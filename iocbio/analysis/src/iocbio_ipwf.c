  ...
  if (j>=0 && j<=n-2)
  {
    for(p=0; p<m; ++p, f+=n)
    {
      ...
      for(i=0;i<=k;++i)
      {
        ...
        f_i = F(i);
        f_ip1 = F(i+1);
        b0 += FRAC_1_3*(f_ip1*(f_ip1 + f_i - f_ipj - 2*f_ip1pj) + f_ipj*(f_ip1pj + f_ipj) + (f_i - f_ip1pj - 2*f_ipj)*f_i + (f_ip1pj*f_ip1pj));
        ...
        b3 += FRAC_1_3*(f_ip2pj*(f_ip1 + f_ip2pj - f_i) + f_ipj*(f_ip1 - f_i - f_ipj) + f_ip1pj*(2*f_i + 2*f_ipj - 2*f_ip1 - 2*f_ip2pj));
      }
      b0 += FRAC_1_3*((f_m1pn + f_m2pn)*f_m1pn + (f_m2pn*f_m2pn) + (f_m1mjpn - f_m2pn - 2*f_m1pn)*f_m1mjpn + f_m2mjpn*(f_m1mjpn + f_m2mjpn - f_m1pn - 2*f_m2pn));
      b1 += -f_m2mjpn*f_m1pn + (f_m2pn + f_m1pn - f_m1mjpn)*f_m1mjpn + f_m2pn*(f_m2mjpn - f_m2pn);
      b2 += f_m2mjpn*f_m1pn + (f_m1mjpn - f_m2mjpn - f_m2pn)*f_m1mjpn + f_m2pn*(f_m2pn - f_m1pn);
      b3 += FRAC_1_3*(-(f_m1pn*f_m1pn) + f_m2pn*(2*f_m1pn - f_m2pn) + (f_m1pn - f_m2mjpn - f_m2pn)*f_m2mjpn + f_m1mjpn*(2*f_m2mjpn + f_m2pn - f_m1mjpn - f_m1pn));
    }
  }
  *a0 = b0;
  *a1 = b1;
  ...
  if (j>=0 && j<=n-2)
  {
    for(p=0; p<m; ++p, f+=n)
    {
      ...
      for(i=0;i<=k;++i)
      {
        ...
        b2 += f_ip2pj*(f_ip1 + f_ip2pj - f_i) + 2*f_ip1pj*(f_i + f_ipj - f_ip1 - f_ip2pj) + f_ipj*(f_ip1 - f_i - f_ipj);
      }
      b0 += -f_m2mjpn*f_m1pn + (f_m2pn + f_m1pn - f_m1mjpn)*f_m1mjpn + f_m2pn*(f_m2mjpn - f_m2pn);
      b1 += 2*(f_m2mjpn*f_m1pn + (f_m1mjpn - f_m2mjpn - f_m2pn)*f_m1mjpn + f_m2pn*(f_m2pn - f_m1pn));
      b2 += -(f_m1pn*f_m1pn) + f_m2mjpn*(2*f_m1mjpn - f_m2pn + f_m1pn - f_m2mjpn) + f_m2pn*(2*f_m1pn - f_m2pn) + (f_m2pn - f_m1mjpn - f_m1pn)*f_m1mjpn;
    }
  }
  *a0 = b0;
  *a1 = b1;
  ...
  if (j>=0 && j<=n-2)
  {
    for(p=0; p<m; ++p, f+=n)
    {
      ...
      for(i=0;i<=k;++i)
      {
        ...
        b1 += 2*(f_ip2pj*(f_ip1 + f_ip2pj - f_i) + f_ipj*(f_ip1 - f_i - f_ipj)) + 4*f_ip1pj*(f_i + f_ipj - f_ip1 - f_ip2pj);
      }
      b0 += 2*(f_m2mjpn*f_m1pn + (f_m1mjpn - f_m2mjpn - f_m2pn)*f_m1mjpn + f_m2pn*(f_m2pn - f_m1pn));
      b1 += 2*(-(f_m1pn*f_m1pn) + (f_m1pn - f_m2mjpn - f_m2pn)*f_m2mjpn) + f_m2pn*(4*f_m1pn + 2*-f_m2pn) + f_m1mjpn*(4*f_m2mjpn + 2*(f_m2pn - f_m1mjpn - f_m1pn));
    }
  }
  *a0 = b0;
  *a1 = b1;
  ...
  if (j>=0 && j<=n-2)
  {
    for(p=0; p<m; ++p, f+=n)
    {
      ...
      for(i=0;i<=k;++i)
      {
        ...
        f_i = F(i);
        f_ip1 = F(i+1);
        b0 += 2*(f_ip2pj*(f_ip1 + f_ip2pj - f_i) + f_ipj*(f_ip1 - f_i - f_ipj)) + 4*f_ip1pj*(f_i + f_ipj - f_ip1 - f_ip2pj);
      }
      b0 += 2*(-(f_m1pn*f_m1pn) + (f_m2pn - f_m1mjpn - f_m1pn)*f_m1mjpn) + f_m2pn*(4*f_m1pn + 2*-f_m2pn) + f_m2mjpn*(4*f_m1mjpn + 2*(-f_m2pn + f_m1pn - f_m2mjpn));
    }
  }
  *a0 = b0;
  *a1 = b1;
...
void iocbio_ipwf_a11_compute_coeffs_diff0(int j, double *fm, int n, int m, double* a0, double* a1, double* a2, double* a3)
{
  ...
  if (j>=0 && j<=n-2)
  {
    for(p=0; p<m; ++p, f+=n)
    {
      ...
      b0 += f_m1mjpn*(1.0/3.0*-f_m1pn + 1.0/6.0*-f_m2pn) + 1.0/3.0*-f_m2pn*f_m2mjpn + 1.0/6.0*-f_m2mjpn*f_m1pn;
      b1 += FRAC_1_2*(f_m2pn*f_m2mjpn - f_m2mjpn*f_m1pn + (f_m1pn + f_m2pn)*f_m1mjpn);
      b2 += FRAC_1_2*(-f_m2pn*f_m1mjpn + f_m2mjpn*f_m1pn);
      b3 += FRAC_1_6*(-f_m2pn*f_m2mjpn + f_m2mjpn*f_m1pn + f_m1mjpn*(f_m2pn - f_m1pn));
    }
  }
  *a0 = b0;
  *a1 = b1;
...
void iocbio_ipwf_a11_compute_coeffs_diff1(int j, double *fm, int n, int m, double* a0, double* a1, double* a2, double* a3)
{
  ...
  if (j>=0 && j<=n-2)
  {
    for(p=0; p<m; ++p, f+=n)
    {
      ...
      b0 += FRAC_1_2*(f_m2pn*f_m2mjpn - f_m2mjpn*f_m1pn + (f_m1pn + f_m2pn)*f_m1mjpn);
      b1 += -f_m2pn*f_m1mjpn + f_m2mjpn*f_m1pn;
      b2 += FRAC_1_2*(-f_m2pn*f_m2mjpn + f_m2mjpn*f_m1pn + f_m1mjpn*(f_m2pn - f_m1pn));
    }
  }
  *a0 = b0;
  *a1 = b1;
...
void iocbio_ipwf_a11_compute_coeffs_diff2(int j, double *fm, int n, int m, double* a0, double* a1, double* a2, double* a3)
{
  ...
  if (j>=0 && j<=n-2)
  {
    for(p=0; p<m; ++p, f+=n)
    {
      ...
      b1 += -f_m2pn*f_m2mjpn + f_m2mjpn*f_m1pn + f_m1mjpn*(f_m2pn - f_m1pn);
    }
  }
  *a0 = b0;
  *a1 = b1;
...
void iocbio_ipwf_a11_compute_coeffs_diff3(int j, double *fm, int n, int m, double* a0, double* a1, double* a2, double* a3)
{
  ...
  if (j>=0 && j<=n-2)
  {
    for(p=0; p<m; ++p, f+=n)
    {
      ...
      b0 += -f_m2pn*f_m2mjpn + f_m2mjpn*f_m1pn + f_m1mjpn*(f_m2pn - f_m1pn);
    }
  }
  *a0 = b0;
  *a1 = b1;
