...
extern double fperiod_compute_period(double* f, int n, int m, double structure_size, double exp, int method);
extern double fperiod_compute_period_cache(double* f, int n, int m, double structure_size, double exp, int method, double *r);
extern double fperiod_find_acf_maximum(double* f, int n, int m, int lbound, int ubound);
extern double fperiod_find_acf_d2_minimum(double* f, int n, int m, int lbound, int ubound);
extern double fperiod_acf(double y, double* f, int n, int m);
extern double fperiod_acf_d1(double y, double* f, int n, int m);
extern double fperiod_acf_d2(double y, double* f, int n, int m);
